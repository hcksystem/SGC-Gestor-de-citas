                    ...
                    <div class="card-header">
                        ...
                        <div class="modal">
                            <div class="contenedorlista" style="overflow: scroll">
                                ...
                                <h5>Facturación</h5>
                                <br />
                                <p>En la parte superior se mostrarán espacios importantes para poder efectuar la factura.
                                    <br />
                               ...
                               <h6>Cliente</h6>
                                <p>Espacio donde se debe elegir al cliente al que se va a facturar, puede buscarlo por cualquier dato: nombre, apellido, identificación, teléfono o id. <br />
                                    Estos estan divididos por su rol dentro del sistema: <br />por ejemplo: <br /> 
                             ...
                             <br />
                                ...
                                <br />
                                <h6>Servicios</h6>
                                <p>Espacio donde se debe elegir el servicio que se va a facturar, puede buscarlo por cualquier dato: nombre del servicio, precio, o id. <br />
                                ...
                                <p>
                                    Botón que se encarga de escribir una línea del detalle de la factura, este se irá agregando cada vez que se elija un producto o un servicio.</p>
                                <br />
                                <h6>Total</h6>
                                <p>
                            ...
                            <h6>Botón guardar</h6>
                            <p>Botón encargado de guardar la factura</p><br />
                        ...
                        ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-md-6">
                                <div class="form-inline">
                                    ...
                                    <asp:TextBox ID="txtCantidad" TextMode="Number" Text="1" runat="server" CssClass="form-control-sm"></asp:TextBox>
